...
## Original creator and project architect
...
When sharing, redistributing, or adapting this project, keep the `LICENSE` and `NOTICE` files with the distribution so the original authorship remains visible.
