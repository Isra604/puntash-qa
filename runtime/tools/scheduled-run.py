...
def main():
    ...
    try:
        if os.name=='nt' and msvcrt:
            ...
            except OSError:save('SKIPPED_OVERLAP','Another scheduled QA run is already active.');return 8
        elif fcntl:
            ...
            save('BLOCKED','No supported OS file-lock primitive is available for scheduled-run overlap protection.');return 8
