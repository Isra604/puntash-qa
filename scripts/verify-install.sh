...
for f in AGENT_INSTRUCTIONS.md config/default.yaml profile/PROJECT_QA_PROFILE.md state/FINDING_LEDGER.jsonl INSTALLATION.json LICENSE NOTICE CREDITS.md state/FIRST_RUN_ATTRIBUTION_PENDING.txt; do
