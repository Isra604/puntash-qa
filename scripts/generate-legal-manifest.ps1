...
$manifest=[ordered]@{system='PUNTASH QA';package_version=$version;terms_version=$terms;algorithm='SHA-256';line_endings='LF';documents=$hashes}|ConvertTo-Json -Depth 6
